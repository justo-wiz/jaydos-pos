...
<ol class="breadcrumb float-xl-right">
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Jaydos</a></li>
...
<div class="row">
    ...
    <div class="col-xl-6">
        <!-- begin card -->
        <div class="card border-0 mb-3 overflow-hidden bg-blue-dark text-white">
            <!-- begin card-body -->
            <div class="card-body">
                <!-- begin row -->
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-4 align-items-center d-flex justify-content-center">
                        <img src="{{ asset('backend/admin/assets/img/svg/img-1.svg')}}" height="150px" class="d-none d-lg-block" />
                    </div>
                    <!-- end col-5 -->
                </div>
                <!-- end row -->
    ...
    <div class="col-xl-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <!-- begin card -->
                <div class="card border-0 text-truncate mb-3 bg-blue-dark text-white">
                    <!-- begin card-body -->
                    <div class="card-body">
                        <!-- begin title -->
                        <div class="mb-3 text-grey">
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-6">
        <!-- begin card -->
        <div class="card border-0 mb-3 bg-blue-dark text-white">
            <div class="card-body">
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-6">
        <!-- begin card -->
        <div class="card border-0 mb-3 bg-blue-dark-darker text-white">
            <!-- begin card-body -->
            ...
            <div class="widget-list widget-list-rounded inverse-mode">
                ...
                <a href="#" class="widget-list-item rounded-0 p-t-3 bg-blue-dark">
                ...
                <a href="#" class="widget-list-item bg-blue-dark">
                    ...
                    <div class="widget-list-action text-nowrap text-grey border-top-0">
                ...
                <!-- end widget-list-item -->
                <!-- begin widget-list-item -->
                <a href="#" class="widget-list-item p-b-3 bg-blue-dark">
                    <div class="widget-list-media icon">

    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu media-list dropdown-menu-right">
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="{{asset('backend/admin/assets/img/user/user-1.jpg')}}" class="media-object" alt="" />
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="{{ asset('backend/admin/assets/img/user/user-2.jpg')}}" class="media-object" alt="" />
                        <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                    </div>
                    <div class="media-body">
        ...
        <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <span class="d-none d-md-inline">Hi, {{$profiledata->username}}</span>
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{ route('admin.editprofile')}}" class="dropdown-item">Edit Profile</a>
